...
public class Biblioteca {
    ...
    public Stack<Libro> getListaLibros() {
        return listaLibros;
    }
    ...
    public void setListaLibros(Stack<Libro> listaLibros) {
     ...
     */
     ...
     public String registrarBibliotecario(Bibliotecario nuevoBibliotecario) {
        if (nuevoBibliotecario.getCedula() == null || nuevoBibliotecario.getNombre() == null) {
            throw new IllegalArgumentException("Datos del bibliotecario no pueden ser nulos");
        }
    ...
    public String registrarEstudiante(Estudiante nuevoEstudiante) {
        if (nuevoEstudiante.getCedula() == null || nuevoEstudiante.getNombre() == null) {
            throw new IllegalArgumentException("Datos del estudiante no pueden ser nulos");
        }
        String mensaje = "";
    ...
    public String registrarLibro(Libro nuevoLibro) {
        if (nuevoLibro.getCodigo() == null || nuevoLibro.getTitulo() == null) {
            throw new IllegalArgumentException("Datos del libro no pueden ser nulos");
        }
        String mensaje = "";
    ...
    public String registrarPrestamo(Prestamo nuevoPrestamo) {
        if (nuevoPrestamo.getCodigo() == null || nuevoPrestamo.getEstudiante() == null) {
            throw new IllegalArgumentException("Datos del prestamos no pueden ser nulos");
        }
        String mensaje = "";
